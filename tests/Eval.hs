  ...
  , Submission -- ^ Fibonacci sequence incorrectly defined as f_(n+2) = f_n + f_n
      ...
      , testResults =
          [ [ TestCaseRun $ TestRun "1"
              ...
              , TestCaseRun $ TestRun "4"]
          , [TestCaseCompilefail, TestCaseCompilefail, TestCaseCompilefail]]
      , testSummary =
          mempty { okTest = 3, failedTest = 6, compileFailTest = 3 }
      , points = 15
      }
  , Submission -- ^ Fibonacci sequence incorrectly defined as f_(n+2) = f_n + f_n
      ...
      , testResults = [ [ TestCaseRun $ TestRun "1"
                      ...
                      , [ TestCaseRun $ TestRun "6"
                          ...
                          , TestCaseRun $ TestRun "3628800"]]
      , testSummary =
          mempty { okTest = 6, failedTest = 3, compileFailTest = 0 }
      , points = 45
      }
  ...
  , Submission -- ^ No submission for that matriculation number
      ...
      , testResults =
          [ [ TestCaseNotSubmitted
              ...
              , TestCaseNotSubmitted
              , TestCaseNotSubmitted]
          , [TestCaseNotSubmitted, TestCaseNotSubmitted, TestCaseNotSubmitted]]
...
spec :: Spec
spec = describe "evaluate students"
  ...
  $ do
    it "evaluate tests"
      $ do
        report
          <- runEvalStudent testCourse testSuiteSimple (student submission)
