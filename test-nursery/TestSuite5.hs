  ...
  T.runTestSuite 5 $
    T.testSuite
      [ T.group (T.TestGroupProps "All Properties" 5 0 25)
        [ $(T.testcase [e| fmap Q.isSuccess (Q.quickCheckWithResult Q.stdArgs { Q.chatty = False} prop_ccc_1) `T.assertEqualIO` True |])
        ...
        , $(T.testcase [e| fmap Q.isSuccess (Q.quickCheckWithResult Q.stdArgs { Q.chatty = False} prop_ccc_4) `T.assertEqualIO` True |])
      ...
      , T.group (T.TestGroupProps "Classifiers" 5 0 25)
        ...
        , $(T.testcase [e| fmap Q.isSuccess (Q.quickCheckWithResult Q.stdArgs { Q.chatty = False} (prop_ccd 10)) `T.assertEqualIO` True |])
        , $(T.testcase [e| fmap Q.isSuccess (Q.quickCheckWithResult Q.stdArgs { Q.chatty = False} prop_greedy) `T.assertEqualIO` True |])
        ]
